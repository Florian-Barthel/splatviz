...
def set_default_style(color_scheme="dark", spacing=5, indent=20, scrollbar=10):
    ...
    background = imgui.ImVec4(0.20, 0.20, 0.20, 1.00)
    text_color = imgui.ImVec4(1.00, 1.00, 1.00, 1.00)
    yellow_active = imgui.ImVec4(0.90, 0.70, 0.00, 1.00)
    yellow_inactive = imgui.ImVec4(0.90, 0.70, 0.00, 0.70)


    s.set_color_(COLOR_TEXT,                        text_color)
    s.set_color_(COLOR_TEXT_DISABLED,               imgui.ImVec4(0.50, 0.50, 0.50, 1.00))
    s.set_color_(COLOR_WINDOW_BACKGROUND,           imgui.ImVec4(0.25, 0.25, 0.25, 1.00))

    s.set_color_(COLOR_CHILD_BACKGROUND,            background)
    ...
    s.set_color_(COLOR_FRAME_BACKGROUND,            imgui.ImVec4(0.10, 0.10, 0.10, 0.50))
    s.set_color_(COLOR_FRAME_BACKGROUND_HOVERED,    imgui.ImVec4(0.20, 0.20, 0.20, 0.50))
    s.set_color_(COLOR_FRAME_BACKGROUND_ACTIVE,     imgui.ImVec4(0.20, 0.20, 0.20, 1.00))
    ...
    s.set_color_(COLOR_SLIDER_GRAB,                 yellow_inactive)
    s.set_color_(COLOR_SLIDER_GRAB_ACTIVE,          yellow_active)

    s.set_color_(COLOR_BUTTON,                      yellow_inactive)
    s.set_color_(COLOR_BUTTON_HOVERED,              yellow_active)
    s.set_color_(COLOR_BUTTON_ACTIVE,               yellow_active)
